...
import org.eu.droid_ng.systemui.qs.AlphaControlledSignalTileView.AlphaControlledSlashImageView;
...
public class QSIconViewImpl extends QSIconView {
    ...
    public QSIconViewImpl(Context context) {
        ...
        mIconSizePx = QsPlugin.getPluginResources().getDimensionPixelSize(R.dimen.qs_tile_icon_size);
    ...
    protected void setIcon(ImageView iv, QSTile.State state, boolean allowAnimations) {
        if (state.disabledByPolicy) {
            iv.setColorFilter(getContext().getColor(getContext().getResources().getIdentifier("qs_tile_disabled_color", "color", "com.android.systemui")));
        } else {
            iv.clearColorFilter();
        }
